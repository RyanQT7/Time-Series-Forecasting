...
class VisionTextDualEncoderForClassificationConfig(PretrainedConfig):
    ...
    @classmethod
    def from_vision_text_configs(cls, vision_config: PretrainedConfig, text_config: PretrainedConfig, num_classes, **kwargs):
        r"""
        ...
        return cls(vision_config=vision_config.to_dict(), text_config=text_config.to_dict(), num_classes=num_classes, **kwargs)
